                            ...
                            <div class="col-sm-12 col-lg-4 order-last">
                                <div class="d-flex align-items-center justify-content-center">
                                    <ul
                                        ...
                                        <li class="position-relative">
                                            <a href="javascript:void(0);"
                                                class="text-white d-flex align-items-center justify-content-center bg-info p-2 fs-4 rounded-circle"
                                                width="30" height="30">
                                        ...
                                        <li class="position-relative">
                                            <a href="javascript:void(0);"
                                                class="text-white d-flex align-items-center justify-content-center bg-danger p-2 fs-4 rounded-circle"
                                                width="30" height="30">
                        ...
                        <div class="card shadow-none border">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li class="d-flex align-items-center gap-3 mb-4" v-if="profile.location">
                                        <i class='bx bxs-map fs-5'></i>
                                        <h6 class="fs-6 text-secondary fw-semibold mb-0">{{ profile.location.state }}, {{ profile.location.country }}</h6>
                                    </li>
